      ...
      <div className="px-[8%] lg:px-[12%] py-20">
        ...
        <div className="mt-10">
          ...
          <p className="text-gray-500 GolosText mt-5">
            The wooden cabin design highlights a seamless blend of organic
            architecture and magical atmosphere, with its curved roof
            harmonizing with the snowy landscape, warm timber walls radiating
            golden light from within, and expansive windows framing direct views
            of the aurora borealis in vivid green and turquoise; the surrounding
            snow covered trees and a pathway illuminated by blue lights provide
            natural framing and futuristic contrast, while the overall
            composition conveys serenity, intimacy, and exclusivity an ideal
            branding concept for Nordic Escape, where the warmth of the cabin
            meets the wonder of nature as a symbol of retreat, healing, and
        ...
        <div className="mt-10">
          ...
          <p className="text-gray-500 GolosText mt-5">
            By cultivating multi sensory experiences, we can create interiors
            that harmonize with the rhythms of the natural world. These spaces
            immerse us in organic textures, daylight, greenery, and flowing air,
            proven to inspire, restore balance, and enhance well being. Beyond
            these benefits, nature centered design reduces stress, nurtures
            creativity, and accelerates healing. In increasingly urbanized
            environments, nature design offers a more humanistic and sustainable
            approach, reconnecting people with earth’s elements. The result is
            interiors that celebrate how we live, work, and grow alongside
            nature. Rooted in biophilia literally “the love of living things”
            this philosophy embraces our innate bond with the environment,
            transforming design into a pathway of renewal and connection.
          </p>
        </div>
      </div>
            ...
            <SwiperSlide key={index}>
              <div className="project-card group">
                ...
                <div className="project-info my-5">
                  <Link href={`/UI-Component/Projects/${project.id}`}>
                  ...
                  <p className="GolosText text-md text-ggray-700">
                    {project.date}
                  </p>
                </div>
              </div>
